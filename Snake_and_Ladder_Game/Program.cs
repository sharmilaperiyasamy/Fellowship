...
namespace SnakeandLadderGame
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //1 ->Player1 is playing. 2->Player2 is playing
            int playerChange = 1;
            while (playerPos1 <= 100 || playerPos2 <= 100)
            {
                ...
                Console.WriteLine("DiceNumber is : " + rollDice + "\n");
                ...
                //Goes to this loop if Player1 is rolling dice
                if (playerChange == 1)
                {
                    ...
                    //If after rolling dice player reached "Exactly 100" then it will increment and come out of loop. Winner is Player1
                    if (list[index] == "Ladder" && (playerPos1 + rollDice == 100|| playerPos1 == 2) && playerChange == 1)
                    {
                        playerPos1 += rollDice;
                        break;
                    }
                ...
                //Goes to this loop if Player2 is rolling dice
            ...
            if (playerPos1 == 100)
            {
                Console.WriteLine("Winner is player1 :" + playerPos1);
                Console.WriteLine("Final position of player 2 :" + playerPos2);
            }
            else
            {
                Console.WriteLine("Winner is player2 :" + playerPos2);
