        ...
        void performAction(string selection)
        {
            ...
            switch (selection.ToUpper())
            {
                case "A":
                    ...
                    {
                        Console.WriteLine("Address is added successfully!");
                    }
                    else
                    {
                        Console.WriteLine("An address is already on fie for {0}.", name);
                    }
                    break;
                case "D":
                    ...
                    if (book.remove(name))
                    {
                        Console.WriteLine("Address is successfully deleted");
                    }
                    else
                    {
